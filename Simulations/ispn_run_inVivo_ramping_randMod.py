...
def run_model(cell_index, ci, modulation_DA, modulation_ACh):
    ...
    for bg in range(nbg):    
        ...
        RES[bg] = [vm[ind]   for ind,t in enumerate(tm) if ind%4 == 0]
...
if __name__ == "__main__":
    ...
    for i in range(20):
        ...
        res[i][cond_id] = run_model(cell_index, cond_id, modulation_DA, modulation_ACh) 
        res[i][cond_id]['factors'] = {'da': modulation_DA, 'ach': modulation_ACh }   
